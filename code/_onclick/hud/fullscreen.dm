...
//There's 100% a cleaner way to do fullscreen overlays for suppression than porting old baycode but I'm tired.
/mob
...
/obj/screen/fullscreen/suppression
	icon_state = "suppressionoverlay"
